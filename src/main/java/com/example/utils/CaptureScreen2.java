...
public class CaptureScreen2 extends JFrame implements ActionListener{
    ...
    private void initWindow(){
        ...
        this.addWindowListener(new WindowAdapter(){
            public void windowClosing(WindowEvent we){
                CaptureScreen2.this.setVisible(false);
            }
        });
    }
        ...
        try{
            ...
            pm.add(new MenuItem("关于")).addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    JOptionPane.showMessageDialog(CaptureScreen2.this,"<html><Font color=red><center><h2>关于</h2></center></Font>" +
            ...
            pm.add(new MenuItem("显示主窗口")).addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    CaptureScreen2.this.setVisible(true);
                }
            });
    ...
    private class SaveAllThread extends JDialog implements Runnable{
        ...
        public SaveAllThread(String name,String ext){
            super(CaptureScreen2.this,"保存",true);
            this.name=name;
            this.ext=ext;
            initWindow();
        }
        private void initWindow(){
            ...
            this.setLocationRelativeTo(CaptureScreen2.this);
